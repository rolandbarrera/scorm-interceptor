(function(window) {
  ...
  function scormToxApi(element, value) {
    ...
    statement.context.extensions[baseContext + 'element'] = element;
    statement.context.extensions[baseContext + 'value'] = value;
    statement.object.context = {extensions: {
      "https://elmnts.com/courseware/pageURI": window.location.href,
      "https://elmnts.com/courseware/pageTitle": document.title
    }};
